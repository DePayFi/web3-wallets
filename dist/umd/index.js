(function (global, factory) {
  ...
  class WorldApp {
    ...
    async transactionCount({ blockchain, address }) {
      if(!_optionalChain$1([worldcoinPrecompiled.MiniKit, 'optionalAccess', _29 => _29.walletAddress])) {
        return 0
      } else {
        return web3Client.request({
          blockchain: 'worldchain',
          address: _optionalChain$1([worldcoinPrecompiled.MiniKit, 'optionalAccess', _30 => _30.walletAddress]),
