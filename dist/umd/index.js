(function (global, factory) {
  ...
  class WorldApp {
          ...
          transaction: [
            {
              ...
              abi: _optionalChain$1([transaction, 'access', _3 => _3.api, 'optionalAccess', _4 => _4.filter, 'call', _5 => _5((fragment)=>_optionalChain$1([fragment, 'optionalAccess', _6 => _6.name]) === transaction.method)]),
              functionName: transaction.method,
              args: _optionalChain$1([transaction, 'access', _7 => _7.params, 'optionalAccess', _8 => _8.args])
            },
          ],
          permit2: [_optionalChain$1([transaction, 'access', _9 => _9.params, 'optionalAccess', _10 => _10.permit2])]
        });
        worldcoinPrecompiled.MiniKit.commands.sendTransaction({
          transaction: [
            {
              address: transaction.to,
              abi: _optionalChain$1([transaction, 'access', _11 => _11.api, 'optionalAccess', _12 => _12.filter, 'call', _13 => _13((fragment)=>_optionalChain$1([fragment, 'optionalAccess', _14 => _14.name]) === transaction.method)]),
              functionName: transaction.method,
              args: _optionalChain$1([transaction, 'access', _15 => _15.params, 'optionalAccess', _16 => _16.args])
            },
          ],
          permit2: [_optionalChain$1([transaction, 'access', _17 => _17.params, 'optionalAccess', _18 => _18.permit2])]
        });
        ...
        fetch(`https://public.depay.com/transactions/worldchain/${payload.transaction_id}`, {
          ...
          if(response.ok) {
            ...
            response.json().then((transactionJSON)=>{
              ...
              if(_optionalChain$1([transactionJSON, 'optionalAccess', _19 => _19.external_id])) {
                transaction.id = _optionalChain$1([transactionJSON, 'optionalAccess', _20 => _20.external_id]);
    ...
    async transactionCount({ blockchain, address }) {
      if(!_optionalChain$1([worldcoinPrecompiled.MiniKit, 'optionalAccess', _21 => _21.walletAddress])) {
        return 0
      } else {
        return web3Client.request({
          blockchain: 'worldchain',
          address: _optionalChain$1([worldcoinPrecompiled.MiniKit, 'optionalAccess', _22 => _22.walletAddress]),
