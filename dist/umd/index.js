(function (global, factory) {
  ...
  class Worldapp {
    ...
    sendTransaction({ transaction }) {
      ...
      return new Promise(async(resolve, reject)=>{
        ...
        worldcoinPrecompiled.MiniKit.subscribe(worldcoinPrecompiled.ResponseEvent.MiniAppSendTransaction, (payload)=> {
          ...
          worldcoinPrecompiled.MiniKit.unsubscribe(worldcoinPrecompiled.ResponseEvent.MiniAppSendTransaction);
        });
    ...
    async transactionCount({ blockchain, address }) {
      if(!_optionalChain$1([worldcoinPrecompiled.MiniKit, 'optionalAccess', _8 => _8.walletAddress])) {
        return 0
      } else {
        return web3Client.request({
          blockchain: 'worldchain',
          address: _optionalChain$1([worldcoinPrecompiled.MiniKit, 'optionalAccess', _9 => _9.walletAddress]),
