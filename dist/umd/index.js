(function (global, factory) {
  ...
  class WorldApp {
          ...
          transaction: [
            {
              ...
              args: _optionalChain$1([transaction, 'access', _3 => _3.params, 'optionalAccess', _4 => _4.args])
            },
          ],
          permit2: [_optionalChain$1([transaction, 'access', _5 => _5.params, 'optionalAccess', _6 => _6.permit2])]
        });
        ...
        fetch(`https://public.depay.com/transactions/worldchain/${payload.transaction_id}`, {
          ...
          if(response.ok) {
            ...
            response.json().then((transactionJSON)=>{
              ...
              if(_optionalChain$1([transactionJSON, 'optionalAccess', _11 => _11.external_id])) {
                transaction.id = _optionalChain$1([transactionJSON, 'optionalAccess', _12 => _12.external_id]);
    ...
    async transactionCount({ blockchain, address }) {
      if(!_optionalChain$1([worldcoinPrecompiled.MiniKit, 'optionalAccess', _13 => _13.walletAddress])) {
        return 0
      } else {
        return web3Client.request({
          blockchain: 'worldchain',
          address: _optionalChain$1([worldcoinPrecompiled.MiniKit, 'optionalAccess', _14 => _14.walletAddress]),
