(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@depay/web3-blockchains'), require('ethers'), require('@depay/solana-web3.js'), require('@depay/web3-client-solana'), require('@depay/walletconnect-v1'), require('@depay/coinbase-wallet-sdk')) :
  typeof define === 'function' && define.amd ? define(['exports', '@depay/web3-blockchains', 'ethers', '@depay/solana-web3.js', '@depay/web3-client-solana', '@depay/walletconnect-v1', '@depay/coinbase-wallet-sdk'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Web3Wallets = {}, global.Web3Blockchains, global.ethers, global.SolanaWeb3js, global.Web3Client, global.WalletConnect, global.CoinbaseWalletSdk));
}(this, (function (exports, Blockchains, ethers, solanaWeb3_js, web3ClientSolana, walletconnectV1, coinbaseWalletSdk) { 'use strict';
