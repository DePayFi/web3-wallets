(function (global, factory) {
  ...
  class WorldApp {
    ...
    async account() {
      if(!this.getProvider()) { return undefined }
      return _optionalChain$1([MiniKit, 'access', _17 => _17.user, 'optionalAccess', _18 => _18.walletAddress])
    }
    ...
    connect() {
      ...
      return new Promise( async(resolve, reject)=>{
        ...
        if(_optionalChain$1([MiniKit, 'access', _19 => _19.user, 'optionalAccess', _20 => _20.walletAddress])) {
          return resolve(_optionalChain$1([MiniKit, 'access', _21 => _21.user, 'optionalAccess', _22 => _22.walletAddress]))
        }
        ...
        MiniKit.subscribe(ResponseEvent.MiniAppWalletAuth, async (payload) => {
          ...
          if (payload.status === "error") {
            ...
            return resolve(_optionalChain$1([MiniKit, 'access', _23 => _23.user, 'optionalAccess', _24 => _24.walletAddress]) || _optionalChain$1([window, 'access', _25 => _25.MiniKit, 'optionalAccess', _26 => _26.user, 'optionalAccess', _27 => _27.walletAddress]))
          }
        });
    ...
    async transactionCount({ blockchain, address }) {
      if(!_optionalChain$1([MiniKit, 'optionalAccess', _28 => _28.user, 'optionalAccess', _29 => _29.walletAddress])) {
        return 0
      } else {
        return web3ClientEvm.request({
          blockchain: 'worldchain',
          address: _optionalChain$1([MiniKit, 'optionalAccess', _30 => _30.user, 'optionalAccess', _31 => _31.walletAddress]),
