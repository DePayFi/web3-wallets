(function (global, factory) {
  ...
  class WorldApp {
          ...
          transaction: [
            {
              ...
              abi: api.filter((fragment)=>_optionalChain$1([fragment, 'optionalAccess', _3 => _3.name]) === transaction.method),
              functionName: transaction.method,
              args: _optionalChain$1([transaction, 'access', _4 => _4.params, 'optionalAccess', _5 => _5.args])
            },
          ],
          permit2: [_optionalChain$1([transaction, 'access', _6 => _6.params, 'optionalAccess', _7 => _7.permit2])]
        });
        worldcoinPrecompiled.MiniKit.commands.sendTransaction({
          transaction: [
            {
              address: transaction.to,
              abi: api.filter((fragment)=>_optionalChain$1([fragment, 'optionalAccess', _8 => _8.name]) === transaction.method),
              functionName: transaction.method,
              args: _optionalChain$1([transaction, 'access', _9 => _9.params, 'optionalAccess', _10 => _10.args])
            },
          ],
          permit2: [_optionalChain$1([transaction, 'access', _11 => _11.params, 'optionalAccess', _12 => _12.permit2])]
        });
        ...
        fetch(`https://public.depay.com/transactions/worldchain/${payload.transaction_id}`, {
          ...
          if(response.ok) {
            ...
            response.json().then((transactionJSON)=>{
              ...
              if(_optionalChain$1([transactionJSON, 'optionalAccess', _13 => _13.external_id])) {
                transaction.id = _optionalChain$1([transactionJSON, 'optionalAccess', _14 => _14.external_id]);
    ...
    async transactionCount({ blockchain, address }) {
      if(!_optionalChain$1([worldcoinPrecompiled.MiniKit, 'optionalAccess', _15 => _15.walletAddress])) {
        return 0
      } else {
        return web3ClientEvm.request({
          blockchain: 'worldchain',
          address: _optionalChain$1([worldcoinPrecompiled.MiniKit, 'optionalAccess', _16 => _16.walletAddress]),
