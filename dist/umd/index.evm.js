(function (global, factory) {
  ...
  class WindowEthereum {
    ...
    static __initStatic2() {this.isAvailable = async()=>{ 
      return (
        _optionalChain$g([window, 'optionalAccess', _27 => _27.ethereum]) &&
        // not MetaMask
        !(_optionalChain$g([window, 'optionalAccess', _28 => _28.ethereum, 'optionalAccess', _29 => _29.isMetaMask]) && Object.keys(window.ethereum).filter((key)=>key.match(/^is(?!Connected)(?!PocketUniverse)(?!RevokeCash)/)).length == 1) &&
        // not Coin98
        !_optionalChain$g([window, 'optionalAccess', _30 => _30.coin98]) &&
        // not Trust Wallet
        !(_optionalChain$g([window, 'optionalAccess', _31 => _31.ethereum, 'optionalAccess', _32 => _32.isTrust]) || _optionalChain$g([window, 'optionalAccess', _33 => _33.ethereum, 'optionalAccess', _34 => _34.isTrustWallet])) &&
        // not crypto.com
        !_optionalChain$g([window, 'optionalAccess', _35 => _35.ethereum, 'optionalAccess', _36 => _36.isDeficonnectProvider]) &&
        // not HyperPay
        !_optionalChain$g([window, 'optionalAccess', _37 => _37.ethereum, 'optionalAccess', _38 => _38.isHyperPay]) &&
        // not Phantom
        !(window.phantom && !window.glow && !_optionalChain$g([window, 'optionalAccess', _39 => _39.solana, 'optionalAccess', _40 => _40.isGlow]) && !['isBitKeep'].some((identifier)=>window.solana && window.solana[identifier])) &&
        // not Rabby
        !_optionalChain$g([window, 'optionalAccess', _41 => _41.ethereum, 'optionalAccess', _42 => _42.isRabby]) &&
        // not Backpack
        !_optionalChain$g([window, 'optionalAccess', _43 => _43.backpack, 'optionalAccess', _44 => _44.isBackpack]) &&
        // not TokenPocket
        !_optionalChain$g([window, 'optionalAccess', _45 => _45.ethereum, 'optionalAccess', _46 => _46.isTokenPocket]) && 
        // not BitKeep
        !_optionalChain$g([window, 'optionalAccess', _47 => _47.ethereum, 'optionalAccess', _48 => _48.isBitKeep]) && 
        // not Coinbase
        !(_optionalChain$g([window, 'optionalAccess', _49 => _49.ethereum, 'optionalAccess', _50 => _50.isCoinbaseWallet]) || _optionalChain$g([window, 'optionalAccess', _51 => _51.ethereum, 'optionalAccess', _52 => _52.isWalletLink]))
      )
    };}
